...
<div class="container">
    <div class="row">
        ...
        <div class="buttonarea">
            ...
            if($usertype==1){
        echo    '<button type="button" class="btn btn-secondary btn-sm" onclick="payproceed()" id="ckbtn2" name="ckbtn2"> CHECK OUT</button>';
            }
            else{
         echo  ' <button type="button" class="btn btn-secondary btn-sm" onclick="payproceed()" id="ckbtn2" name="ckbtn2" style="display:none;"> CHECK OUT</button>
