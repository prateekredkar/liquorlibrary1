        ...
        <div id="content">
          ...
          <span class="cart-title"><a href="productlist.php?pid=' . $cartitem_arr['productID'] . '"><span class="itemname">' . $cartitem_arr['productName'] . '</span> / ' . $cartitem_arr['brandName'] . ' - ' . $cartitem_arr['categoryName'] . '</a></span>                
            ...
            <p class="listprice"></p>
                    ...
                    if ($cartitem_arr['discountprice'] !== null) {
                      echo '  
            <td class="cart-item-total last asdfa" id="total[' . $cartitem_arr['productID'] . ']" value="' . $cartitem_arr['totalprice'] . '" data-attribute="' . $cartitem_arr['productID'] . '">Rs.' . $cartitem_arr['totalprice'] . '</td>';
                    } else {
                      echo ' 
            <td class="cart-item-total last asdfa" id="total[' . $cartitem_arr['productID'] . ']" value="' . $cartitem_arr['totalprice'] . '" data-attribute="' . $cartitem_arr['productID'] . '">Rs.' . $cartitem_arr['totalprice'] . '</td>';
                    }
          ...
          <button class="cart-item-remove" value=' . $idJson . ' type="button" onclick="removeItem(this.value)">Remove</button> 
                ...
                <p class="cart-price">TOTAL: Rs.<span class="totalmoney" name="cartTotalPrice" id="cartTotalPrice">0</span></p>';
                } else {
                  echo '
                <div class="cart-tools">
                ...
                <p class="cart-price">TOTAL: Rs.<span class="totalmoney" name="cartTotalPrice" id="cartTotalPrice" value="' . $carttotal . '">' . $carttotal . '</span></p>';
