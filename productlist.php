                    ...
                    echo '
                        ...
                        <div class="product-grid__product col-sm-12 col-md-12 col-lg-12" style="text-align: center; font-family: Montserrat, sans-serif;">
                            ...
                            if($searchItem_arr[$b][3] !==null ){
                                echo      '<div class="product-grid__price"><span style="font-size:1.4rem;">Rs.'.$searchItem_arr[$b][3].'</span> <span style="text-decoration: line-through; color:rgba(48, 43, 41,1); font-size:1rem;"> $'.$searchItem_arr[$b][4].'</span></div>';
                            }
                            else {
                                echo      '<div class="product-grid__price"><span style="font-size:1.4rem;">Rs.'.$searchItem_arr[$b][4].'</span> </div>';
                        ...
                        echo '
                            ...
                            <div class="product-grid__product col-sm-6 col-md-4 col-lg-4" style="text-align: center; font-family: Montserrat, sans-serif;">
                                ...
                                if($suggestItem_arr[$b][3] !==null ){
                                    echo      '<div class="product-grid__price"><span style="font-size:1.4rem;">Rs.'.$suggestItem_arr[$b][3].'</span> <span style="text-decoration: line-through; color:rgba(48, 43, 41,1); font-size:1rem;"> $'.$suggestItem_arr[$b][4].'</span></div>';
                                }
                                else {
                                    echo      '<div class="product-grid__price"><span style="font-size:1.4rem;">Rs.'.$suggestItem_arr[$b][4].'</span> </div>';
