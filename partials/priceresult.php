...
<section>
     ...
     <center><h4 style="margin-top: 100px;"><hr>Price :';echo '<span style="color:#8B0000; font-size: 1.2rem; font-weight:600; ">Rs.'.$searchstart.'~Rs.'.$searchend.'</span></h4></center>
                    ...
                    echo '
                        ...
                        <div class="product-grid__product col-sm-6 col-md-4 col-lg-3" style="text-align: center; font-family: Montserrat, sans-serif;">
                            ...
                            <div class="product-grid__title" style="font-size: 1.2rem;font-weight: 600;"><span>'.$searchPrice_arr[$b]['productName'].'</span></div><br>
                             <div class="product-grid__price"><span style="font-size:1.4rem;">Rs.'.$searchPrice_arr[$b]['price'].'</span> <span style="text-decoration: line-through; color:rgba(48, 43, 41,1); font-size:1rem;"> Rs.'.$searchPrice_arr[$b]['discountprice'].'</span></div>
