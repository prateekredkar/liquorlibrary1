              ...
              <div id="demo" class="collapse show">
                ...
                echo '
                                                        ...
                                                        <div class="col-3 col-xs-4">
                                                            ...
                                                            <div class="row secondRow">
                                                                <h5>Rs.' . $totalbackorder_arr[0][6] . '</h5>
                                                            </div>
                                                        </div>
                ...
                $orderIdArr = array(
                  'orderID' => $totalbackorder_arr[0][0],
                  'buyerID' => $totalbackorder_arr[0][1]
                );
                ...
                echo ' <div class="col-1  p-1 my-auto pl-5" style="font-size:1.25rem;">
                                            ...
                                            <button class="btn btn-danger" style="background-color: black; border:none;" id="cancelbuttonlatest" value=' . $orderidJson . ' onclick="confirmcancel();" ><span id="cancelsignlatest">Cancel</span>                                                  
                                            <span class="spinner-border spinner-border-sm" id="spinnerlatest" role="status" aria-hidden="true" style="display:none"></span>
                                            </button>    
                                            </div>
                ...
                echo '
                                            <div class="col">
                                                <div class="row">
                                                    ...
                                                    <div class="col">
                                                        <h6 class="pr-3"style="font-weight:700; color: black;font-size: 1.3rem; margin-right: 50px;">Rs.' . $res[0]['cost'] . '
                                                    </div>
                                                </div>
                                                <div class="row">
                ...
                echo '<center>There is no order at the moment</center>';
              }
                ?>
                <p></p>
                  ...
                  for ($i = 0; $i < count($shippingorder_arr); $i++) {
                    ...
                    echo '
                                                      ...
                                                      <div class="col-3">
                                                          ...
                                                          <div class="row secondRow">
                                                              <h5>Rs.' . $shippingorder_arr[$i][6] . '</h5>
                                                          </div>
                                                      </div>
              ...
              <div id="demo3" class="collapse">
                ...
                if (!empty($paidorder_arr)) {
                  for ($i = 0; $i < count($paidorder_arr); $i++) {
                    $orderIdArr = array(
                      'orderID' => $paidorder_arr[$i][0],
                      'buyerID' => $paidorder_arr[$i][1]
                    );
                    $orderidJson = json_encode($orderIdArr);
                    echo '
                                          <div class="card">
